...
void DisplayStyle_Portrait_NoBlink () {
  ...
  if (stringComplete) {
    ...
    /* Blank CPU PCB BMP, */
    tft.drawBitmap(16, 25, CPU3_BMP, 82, 82, ILI9341_SILVER);
    ...
    tft.println("RX");
    tft.fillCircle(226, 14, 6, ILI9341_NAVY);// Flash top right corner when updating  //see "serialEvent();" loop
...
#define ILI9341_updateBox  ILI9341_BLACK // Default for normal running
    ...
    */
    ...
    tft.drawBitmap(16, 268, DG_RAM_BMP, 100, 40, ILI9341_LIGHTGREY);
