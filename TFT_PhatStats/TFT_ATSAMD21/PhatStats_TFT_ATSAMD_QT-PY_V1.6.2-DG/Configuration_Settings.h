...
#define CPU_TJMAX 95  //  TJ Max for the Intel 9900K    = 100c
#define GPU_TJMAX 83   //  TJ Max for the Nvidia GTX1080 = 83c

/* CPU & GPU Turbo/Boost Frequency Values in Mhz */
#define CPU_BOOST 3600  //  AMD Ryzen 3700x = 3600MHz Turbo to 4200MHz
#define GPU_BOOST 1410  //  EVGA RTX2070 Black = 1620MHz
